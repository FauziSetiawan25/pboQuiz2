...
public class Main {
    public static void main(String[] args) {
        ...
        pasien1.daftar(rumahSakit1, "PUSING", "WAHAB", orang.tipePasien.MANDIRI);
        pasien2.daftar(rumahSakit1, "PILEK", "WAHAB", orang.tipePasien.MANDIRI);
        pasien3.daftar(rumahSakit1, "MASUK ANGIN", "BELDA", orang.tipePasien.MANDIRI);
        pasien6.daftar(rumahSakit1, "KESELEO", "BELDA", orang.tipePasien.MANDIRI);
        pasien4.daftar(rumahSakit1, "FLU", "FAUZI", orang.tipePasien.MANDIRI);

        pasien5.daftar(rumahSakit1, "BATUK", "LUTHFI", orang.tipePasien.MANDIRI);
        pasien5.daftar(rumahSakit1, "BATUK", "EZRA", orang.tipePasien.MANDIRI);
        pasien5.daftar(rumahSakit1, "BATUK", "EZRA", orang.tipePasien.MANDIRI);
